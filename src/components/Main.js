                                        ...
                                        <div class="row text-light">
                                            <div class="col-6 text-center">
                                                <div class="about-info mt-5">
                                                    <p><span className="fs-2">SK ATIF MOHAMMED</span></p>
                                                    <p><span className="fs-4">Full stack developer</span></p>
                                                    <p><span>https://github.com/MHD17CODE</span></p>
                                                    <a className="btn btn-success" href="#contact">Contact Me!</a>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <img src={require("./Atif.jpeg")} alt="" style={{
                                                    height: "300px",
                                                    padding: "15px",
                                                    display: "block",
                                                    marginLeft: "auto",
                                            ...
                                            <div class="col-12 p-4">
                                                <div class="about-me pt-4 pt-md-0">
                                                    ...
                                                    <p>
                                                    As a B.Tech student, I aim to gain knowledge, expertise, and a deep understanding of the organization's culture. I aspire to create a positive and collaborative work environment. My goal is to actively contribute to the organization's vision and mission, striving to become an integral and valuable member of the team.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Full Name: </span>SHAIK ATIF MOHAMMED</li>
                        <li className="list-group-item"><span className="fw-bold">Birthday: </span>01/10/2003</li>
                    ...
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/MHD17CODE">Click Here</a></li>
